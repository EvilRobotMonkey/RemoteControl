...
//      return;
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (myMotionEvent != null) {
            myMotionEvent.touchEventCallBack(ev);
        }
...
//            toggleMediaControlsVisiblity();
    ...
    public interface MyMotionEvent {
        void touchEventCallBack(MotionEvent ev);
    }

    public MyMotionEvent myMotionEvent;

    public void setMyMotionEvent(MyMotionEvent myMotionEvent) {
        this.myMotionEvent = myMotionEvent;
    }
